...
public class RecipeEntry implements ConfigurationSerializable {
    ...
    public RecipeEntry(Map<String, Object> map) {
        ...
        if (idObj instanceof String idStr
            ...
            id = NamespacedKey.fromString(idStr, RecipeManagerAPI.getInstance());
            basePotionKey = NamespacedKey.fromString(basePotionStr, RecipeManagerAPI.getInstance());
            ...
            resultPotionKey = NamespacedKey.fromString(resultStr, RecipeManagerAPI.getInstance());

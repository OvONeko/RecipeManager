package cx.rain.mc.recipemanager.brewing;
...
import cx.rain.mc.recipemanager.api.event.MorePotionBrewStartEvent;
import cx.rain.mc.recipemanager.utility.PotionItemStackHelper;
...
public class BrewingTicker extends BukkitRunnable {
    ...
    public void start() {
        ...
        if (player != null) {
            ...
            if (!event.isCancelled()) {
                add(this);
                runTaskTimer(RecipeManager.getInstance(), 0, 1);
            }
        }
    }
